...
static void ovrFramebuffer_Acquire(ovrFramebuffer* frameBuffer) {
    ...
    waitInfo.next = NULL;
    waitInfo.timeout = 17000000; /* timeout in nanoseconds */
...
typedef struct {
    XrMatrix4x4f ViewMatrix[MAX_NUM_EYES];
    XrMatrix4x4f ProjectionMatrix[MAX_NUM_EYES];
} ovrSceneMatrices;
...
static void ovrApp_Clear(ovrApp* app) {
    ...
    memset(&app->ViewConfigurationView, 0, MAX_NUM_EYES * sizeof(XrViewConfigurationView));
...
void android_main(struct android_app* app) {
    ...
    XrView* projections = (XrView*)(malloc(MAX_NUM_EYES * sizeof(XrView)));
